...
def run_batch():
	algorithms = [
		...
		## Genetic algorithm
		"tmemetic random_seed=10 generations=100, population=5 selection_percentage=0.5 mutation_probability=0.2",
		"tmemetic random_seed=327489 generations=100, population=5 selection_percentage=0.5 mutation_probability=0.2",
		"tmemetic random_seed=121481 generations=100, population=5 selection_percentage=0.5 mutation_probability=0.2",
